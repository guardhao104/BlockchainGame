...
public class GameUI : MonoBehaviour
{
    ...
    {
        playerCastleText.text = "Castle: " + castle.ToString();
    }

    public void SetOpponentCastle(int castle)
    {
        opponentCastleText.text = "Castle: " + castle.ToString();
    }
    ...
    {
        playerDefenseText.text = "Defense: " + defense;
    }

    public void SetOpponentDefense(int defense)
    {
        opponentDefenseText.text = "Defense: " + defense;
    }
    ...
    {
        playerWorkersText.text = "Workers: " + workers;
    }

    public void SetOpponentWorkers(int workers)
    {
        opponentWorkersText.text = "Workers: " + workers;
    }

    public void SetPlayerBricks(int bricks)
    {
        playerBricksText.text = "Bricks: " + bricks;
    }

    public void SetOpponentBricks(int bricks)
    {
        opponentBricksText.text = "Bricks: " + bricks;
    }

    public void SetPlayerSoldiers(int soldiers)
    {
        playerSoldiersText.text = "Soldiers: " + soldiers;
    }

    public void SetOpponentSoldiers(int soldiers)
    {
        opponentSoldiersText.text = "Soldiers: " + soldiers;
    }

    public void SetPlayerWeapon(int weapon)
    {
        playerWeaponText.text = "Weapons: " + weapon;
    }

    public void SetOpponentWeapon(int weapon)
    {
        opponentWeaponText.text = "Weapons: " + weapon;
    }

    public void SetPlayerMagic(int magic)
    {
        playerMagicText.text = "Magic: " + magic;
    }

    public void SetOpponentMagic(int magic)
    {
        opponentMagicText.text = "Magic: " + magic;
    }

    public void SetPlayerCrystals(int crystals)
    {
        playerCrystalsText.text = "Crystals: " + crystals;
    }

    public void SetOpponentCrystals(int crystals)
    {
        opponentCrystalsText.text = "Crystals: " + crystals;
    }
